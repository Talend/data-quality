...
public class TypoUnicodePatternRecognizerTest {
    ...
    public void testUnicodeStrings() {
        ...
        str = "Ἰοὺ ἰού· τὰ πάντʼ ἂν ἐξήκοι σαφῆ." + "Ὦ φῶς, τελευταῖόν σε προσϐλέψαιμι νῦν,"
        ...
        str = "يَجِبُ عَلَى الإنْسَانِ أن يَكُونَ أمِيْنَاً وَصَادِقَاً مَعَ نَفْسِهِ وَمَعَ أَهْلِهِ وَجِيْرَانِهِ وَأَنْ يَبْذُلَ كُلَّ جُهْدٍ فِي إِعْلاءِ شَأْنِ الوَطَنِ وَأَنْ يَعْمَلَ عَلَى مَا يَجْلِبُ السَّعَادَةَ لِلنَّاسِ . ولَن يَتِمَّ لَهُ ذلِك إِلا بِأَنْ يُقَدِّمَ المَنْفَعَةَ العَامَّةَ عَلَى المَنْفَعَةِ الخَاصَّةِ وَهذَا مِثَالٌ لِلتَّضْحِيَةِ .";
        Assert.assertEquals(
        ...
        str = "子曰：「學而時習之，不1說乎？有朋Aar1AA23自遠方來，不亦樂乎？";
        Assert.assertEquals(
        ...
        // the following are the examples presented in the JavaDoc
        str = "A character is NOT a Word";
        ...
        str = "123@gm  ail123.com";
        Assert.assertEquals("[number]@[word]  [alnum].[word]",
                TypoUnicodePatternRecognizer.noCase().getValuePattern(str).toArray()[0]);
    }
}