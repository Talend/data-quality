...
public class CRCRHandlerTest {
    ...
    public void testHandleRequest() {
        HandlerParameter handlerParameter = createHandlerParameter();
        CRCRHandler crcrHandler = new CRCRHandler(handlerParameter);
    ...
    /**
     * DOC zshen Comment method "createHandlerParameter".
     * 
     * @return
     */
    private HandlerParameter createHandlerParameter() {
        List<Column> columns = new ArrayList<>();
        DataSet dataset = new DataSet(columns);
        ISurvivoredAction action = RuleDefinition.Function.MostCommon.getAction();
    ...
    public void testLinkSuccessor() {
        HandlerParameter createHandlerParameter = this.createHandlerParameter();
    ...
    public void testGetNonDupResult() {
        ...
        Assert.assertEquals("The result of logest value should be empty", "", nonDupResult.toString());
    }
